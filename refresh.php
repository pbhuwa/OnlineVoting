  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a href="http://localhost/online_voting/index.php">HOME</a></li>
...
<div >
  ...
  <div >
    ...
    width='<?php if(isset($_POST['Submit'])){ if (C|| $candidate_1 != 0){echo(100*round($candidate_1/($candidate_2+$candidate_1),2));}} ?>'
    height='10'>
...
if($candidate_2> $candidate_1){echo"<div style='font-size:35px';'>&nbsp;The winner is $candidate_name_2</div>";}
else if ($candidate_2==$candidate_1){echo "<div style='font-size:35px';'>&nbsp;Votes are tie or no votes are casted</div>";}
if($candidate_1> $candidate_2){echo "<div style='font-size:35px';'>&nbsp;The winner is $candidate_name_1</div>";}?>
  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-phone"></i>014227771<br>
          014227771</li>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2017 - All Rights Reserved - <a href="#">AAPP GROUP</a></p>
