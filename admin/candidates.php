<?php
    ...
    $result= $mysqli->query("SELECT * FROM tbCandidetails")
...
if (isset($_POST['Submit']))
{
    ...
    $sql = $mysqli->query( "INSERT INTO tbCandidetails(candi_name,candi_position) VALUES ('$newCandidateName','$newCandidatePosition')" )
...
<?php
    ...
    // check if the 'id' variable is set in URL
     ...
     // delete the entry
     $result =  $mysqli->query("DELETE FROM tbCandidetails WHERE candidate_id='$id'")
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        ...
        <li><i class="fa fa-envelope-o"></i> nepalgovernment@gmail.com </li>
      </ul>
    </div>
...
<?php
    ...
    echo "<td>" . $row['candi_name']."</td>";
    echo "<td>" . $row['candi_position']."</td>";
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2017 - All Rights Reserved - <a href="#">Nepal government</a></p>
